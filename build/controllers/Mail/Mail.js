...
var MailController = /** @class */ (function () {
    ...
    MailController.prototype.mailer = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var accessToken, smtpConfig, transport, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        transport = nodemailer_1.createTransport(smtpConfig);
                        return [4 /*yield*/, transport.sendMail(message, function (err) {
                                if (err) {
